...
//스레드 만드는 방법2 : Runnable 인테페이스 구현 - Add unimplemented method 절로 생성
public class T2_MultiTrhead2 implements Runnable {

	@Override
	public void run() {
		System.out.println("=================================================");
		System.out.println("1.현재 클래스명 : T2_MultiTrhead2");
...
//		for(int i=0; i<1000000000; i++) {} //지연방법 1.
		...
		System.out.println("=================================================");
		System.out.println("2.현재 클래스명 : T2_MultiTrhead2");
